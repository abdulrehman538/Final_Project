  ...
  return (
    <div className="about-page">
      <section className="about-hero">
        <div className="hero-overlay">
          <div className="container">
            ...
            <p>
              Building trust, delivering quality, and creating exceptional shopping
              experiences for customers every day.
            </p>
      ...
      <section className="about-story section">
        <div className="container story-grid">
          <div>
            ...
            <p>
              Since our beginning, we have focused on delivering quality, reliability,
              and customer satisfaction. What started as a small operation has grown
              into a trusted destination for thousands of shoppers.
            </p>
            <p>
              Our commitment to authentic products, excellent service, and continuous
      ...
      <section className="vision-mission section">
        <div className="container vm-grid">
          <div className="vm-card">
            <h3>Our Vision</h3>
            <p>
              To become the most trusted and innovative retail destination, delivering
          ...
          <div className="vm-card">
            <h3>Our Mission</h3>
            <p>
              To enhance everyday life through authentic products, exceptional service,
              and technology-driven convenience.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="ecommerce section">
        <div className="container ecommerce-grid">
          ...
          <div>
            ...
            <p>
              We continue to invest in technology, logistics, and customer experience
              to make shopping faster, easier, and more reliable.
            </p>
      ...
      <section className="highlights section">
        <div className="container">
          <h2 className="center-title">Key Highlights</h2>
      ...
      <section className="payments section">
        <div className="container">
          <h2 className="center-title">Payment Methods</h2>
      ...
      <section className="awards section">
        <div className="container">
          <h2 className="center-title">Recognized For Excellence</h2>
      ...
      <section className="commitment">
        <div className="container">
          ...
          <p>
            We remain committed to delivering authentic products, exceptional service,
            and seamless convenience through every customer interaction.
          </p>
          <button type="button" className="hero-btn">
            Start Shopping
          </button>
